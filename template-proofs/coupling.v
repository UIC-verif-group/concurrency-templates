...
Module Info.
  ...
  Definition source_file := "coupling.c".
...
Definition _md_n : ident := $"md_n".
Definition _md_p : ident := $"md_p".
...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 76) :: Init_int8 (Int.repr 79) ::
                Init_int8 (Int.repr 67) :: Init_int8 (Int.repr 75) ::
                Init_int8 (Int.repr 45) :: Init_int8 (Int.repr 67) ::
...
Definition f_traverse := {|
  ...
  fn_temps := ((_status, tint) :: (_md, (tptr (Tstruct _md_entry noattr))) ::
               ...
               (_md_n, (tptr (Tstruct _md_entry noattr))) ::
               (_md_p, (tptr (Tstruct _md_entry noattr))) ::
               (_t'7, (tptr (Tstruct _md_entry noattr))) ::
               (_t'6, (tptr (Tstruct _md_entry noattr))) :: (_t'5, tint) ::
               (_t'4, (tptr (Tstruct _md_entry noattr))) :: (_t'3, tint) ::
               (_t'2, tint) :: (_t'1, (tptr (Tstruct _md_entry noattr))) ::
               (_t'21, (tptr (Tstruct _node noattr))) ::
               (_t'20, (tptr (Tstruct _atom_int noattr))) ::
               (_t'19, (tptr (Tstruct _node noattr))) ::
               (_t'18, (tptr (Tstruct _atom_int noattr))) ::
               ...
               (_t'10, (tptr (Tstruct _atom_int noattr))) ::
               (_t'9, (tptr (Tstruct _node noattr))) ::
               (_t'8, (tptr (Tstruct _atom_int noattr))) :: nil);
  fn_body :=
(Ssequence
      ...
      (Ssequence
        ...
        (Scall (Some _t'1)
          ...
          ((Etempvar _c (tptr (Tstruct _css noattr))) ::
           (Etempvar _t'21 (tptr (Tstruct _node noattr))) :: nil)))
      ...
      (Ssequence
        ...
        (Scall None
          (Evar _acquire (Tfunction
                           ...
                           cc_default))
          ((Etempvar _t'20 (tptr (Tstruct _atom_int noattr))) :: nil)))
      (Ssequence
        (Ssequence
          (Sset _t'16
            (Efield
          ...
          (Sifthenelse (Eunop Onotbool
                         (Etempvar _t'16 (tptr (Tstruct _node noattr))) tint)
            (Ssequence
              (Sset _r
                (Efield
                  (Ederef (Etempvar _c (tptr (Tstruct _css noattr)))
                ...
                (Ssequence
                  ...
                  (Ssequence
                    ...
                    (Scall (Some _t'3)
                      (Evar _hash (Tfunction ((tptr tvoid) :: nil) tint
                                    cc_default))
                      ((Etempvar _t'19 (tptr (Tstruct _node noattr))) :: nil))))
                  ...
                  (Ssequence
                    ...
                    (Ssequence
                      ...
                      (Scall None
                        ...
                        ((Etempvar _t'18 (tptr (Tstruct _atom_int noattr))) ::
                         nil)))))))
            (Ssequence
              (Sset _t'17
                (Efield
            ...
            (Ssequence
              ...
              (Scall (Some _t'4)
                (Evar _lookup_md (Tfunction
                                   ...
                                   cc_default))
                ((Etempvar _c (tptr (Tstruct _css noattr))) ::
                 (Etempvar _t'15 (tptr (Tstruct _node noattr))) :: nil)))
            (Sset _md_n (Etempvar _t'4 (tptr (Tstruct _md_entry noattr)))))
          (Ssequence
            (Ssequence
              (Sset _t'14
                (Efield
                  (Ederef (Etempvar _md_n (tptr (Tstruct _md_entry noattr)))
                    (Tstruct _md_entry noattr)) _lock
                  (tptr (Tstruct _atom_int noattr))))
              (Scall None
                (Evar _acquire (Tfunction
                            ...
                            (Ssequence
                              (Ssequence
                                (Sset _t'10
                                  (Efield
                                    (Ederef
                                      (Etempvar _md_n (tptr (Tstruct _md_entry noattr)))
                                      (Tstruct _md_entry noattr)) _lock
                                    (tptr (Tstruct _atom_int noattr))))
                                (Scall None
                                  (Evar _acquire (Tfunction
                                                   ((tptr (Tstruct _atom_int noattr)) ::
                                                    nil) tvoid cc_default))
                                  ((Etempvar _t'10 (tptr (Tstruct _atom_int noattr))) ::
                                   nil)))
                              (Ssequence
                                (Ssequence
                                  (Ssequence
                                ...
                                (Ssequence
                                  (Sset _t'8
                                    (Efield
                                      (Ederef
                                        (Etempvar _md_p (tptr (Tstruct _md_entry noattr)))
                                        (Tstruct _md_entry noattr)) _lock
                                      (tptr (Tstruct _atom_int noattr))))
                                  (Scall None
                                    (Evar _release (Tfunction
...
Definition f_insertOp_helper := {|
  ...
  fn_temps := ((_new_node, (tptr (Tstruct _node noattr))) ::
               ...
               (_t'8, (tptr (Tstruct _md_entry noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
  ...
  (Ssequence
    (Sifthenelse (Eunop Onotbool
                   (Etempvar _new_node (tptr (Tstruct _node noattr))) tint)
      (Ssequence
        (Ssequence
          (Scall (Some _t'2)
            (Evar _lookup_md (Tfunction
        ...
        (Ssequence
          ...
          (Ssequence
            (Ssequence
              ...
              (Sassign
                (Efield
                  (Ederef (Etempvar _t'8 (tptr (Tstruct _md_entry noattr)))
                    (Tstruct _md_entry noattr)) _lock
                  (tptr (Tstruct _atom_int noattr)))
        ...
        (Ssequence
          ...
          (Ssequence
            (Ssequence
              ...
              (Sassign
                (Efield
                  (Ederef (Etempvar _t'5 (tptr (Tstruct _md_entry noattr)))
                    (Tstruct _md_entry noattr)) _lock
                  (tptr (Tstruct _atom_int noattr)))
                (Etempvar _lock (tptr (Tstruct _atom_int noattr)))))
            (Ssequence
...
(_printDS_helper :: _get_root :: _make_css :: _lookupOp_helper ::
 _insertOp_helper :: _traverse :: _lookup_md :: _printDS :: _get_value ::
 _insertOp :: _findNext :: _release :: _acquire :: _makelock :: _exit ::
