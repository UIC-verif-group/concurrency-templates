...
Definition _get_left : ident := $"get_left".
Definition _get_right : ident := $"get_right".
...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 70) :: Init_int8 (Int.repr 111) ::
                ...
                Init_int8 (Int.repr 66) :: Init_int8 (Int.repr 83) ::
...
Definition f_findNext := {|
  ...
  fn_params := ((_p, (tptr (Tstruct _node noattr))) ::
                (_n_tree, (tptr (tptr (Tstruct _node noattr)))) ::
                (_x, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_y, tint) :: (_t'4, (tptr (Tstruct _node noattr))) ::
  ...
  (Sifthenelse (Ebinop Olt (Etempvar _x tint) (Etempvar _y tint) tint)
    (Ssequence
      (Ssequence
        ...
        (Sassign
          (Ederef (Etempvar _n_tree (tptr (tptr (Tstruct _node noattr))))
            (tptr (Tstruct _node noattr)))
      ...
      (Ssequence
        ...
        (Sifthenelse (Eunop Onotbool
                       (Etempvar _t'3 (tptr (Tstruct _node noattr))) tint)
      ...
      (Ssequence
        (Ssequence
          (Sset _t'2
            (Efield
              (Ederef (Etempvar _p (tptr (Tstruct _node noattr)))
                (Tstruct _node noattr)) _right (tptr (Tstruct _node noattr))))
          (Sassign
            (Ederef (Etempvar _n_tree (tptr (tptr (Tstruct _node noattr))))
              (tptr (Tstruct _node noattr)))
...
Definition f_insertOp := {|
  ...
  fn_temps := ((_new_node, (tptr (Tstruct _node noattr))) ::
               ...
               (_t'3, (tptr tvoid)) ::
               (_t'2, (tptr (Tstruct _node noattr))) ::
               (_t'1, (tptr tvoid)) :: (_t'5, tint) :: (_t'4, tint) :: nil);
  fn_body :=
(Ssequence
    ...
    (Ssequence
      (Sset _t'5
        (Efield
          (Ederef (Etempvar _p (tptr (Tstruct _node noattr)))
            (Tstruct _node noattr)) _key tint))
      (Sifthenelse (Ebinop Oeq (Etempvar _t'5 tint) (Etempvar _x tint) tint)
        (Ssequence
          (Sassign
            (Efield
              (Ederef (Etempvar _p (tptr (Tstruct _node noattr)))
      ...
      (Ssequence
        (Scall (Some _t'3)
          (Evar _surely_malloc (Tfunction (tulong :: nil) (tptr tvoid)
                                 cc_default))
          ((Esizeof (Tstruct _node noattr) tulong) :: nil))
        (Sset _new_node__1 (Etempvar _t'3 (tptr tvoid))))
      (Ssequence
        (Sassign
          (Efield
...
(Ssequence
  (Scall None
    (Evar _printf (Tfunction ((tptr tschar) :: nil) tint
                    {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
    ((Evar ___stringlit_2 (tarray tschar 9)) :: nil))
  (Ssequence
...
(Composite _stack Struct
 ...
 Composite _node Struct
   (Member_plain _key tint :: Member_plain _value (tptr tvoid) ::
    Member_plain _left (tptr (Tstruct _node noattr)) ::
    Member_plain _right (tptr (Tstruct _node noattr)) :: nil)
   noattr :: nil).
...
((___compcert_va_int32,
 ...
 (_get_left, Gfun(Internal f_get_left)) ::
 (_get_right, Gfun(Internal f_get_right)) ::
 (_print_key_value, Gfun(Internal f_print_key_value)) ::
 (_printDS, Gfun(Internal f_printDS)) :: nil).

Definition public_idents : list ident :=
(_printDS :: _print_key_value :: _get_right :: _get_left :: _get_key ::
 _get_value :: _insertOp :: _findNext :: _exit :: _malloc :: _printf ::
