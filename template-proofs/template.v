...
Module Info.
  ...
  Definition source_file := "template.c".
...
Definition f_insert := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_t, (tptr (Tstruct _css noattr))) :: (_x, tint) ::
                (_value, (tptr tvoid)) :: nil);
  fn_vars := nil;
  fn_temps := ((_pn__2, (tptr (Tstruct _pn noattr))) :: (_status, tint) ::
               (_t'3, tint) :: (_t'2, (tptr (Tstruct _node noattr))) ::
               (_t'1, (tptr tvoid)) ::
    ...
    (Sassign
      (Efield
        (Ederef (Etempvar _pn__2 (tptr (Tstruct _pn noattr)))
          (Tstruct _pn noattr)) _p (tptr (Tstruct _node noattr)))
            ...
            (Sset _t'4
              (Efield
                (Ederef (Etempvar _pn__2 (tptr (Tstruct _pn noattr)))
                  (Tstruct _pn noattr)) _p (tptr (Tstruct _node noattr))))
            (Scall None
              (Evar _insertOp_helper (Tfunction
                                       ((tptr (Tstruct _css noattr)) ::
                                        (tptr (Tstruct _node noattr)) ::
                                        tint :: (tptr tvoid) :: nil) tvoid
                                       cc_default))
              ((Etempvar _t (tptr (Tstruct _css noattr))) ::
...
Definition f_lookup := {|
  fn_return := (tptr tvoid);
  fn_callconv := cc_default;
  fn_params := ((_t, (tptr (Tstruct _css noattr))) :: (_x, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_pn__2, (tptr (Tstruct _pn noattr))) :: (_v, (tptr tvoid)) ::
               (_status, tint) :: (_t'4, (tptr tvoid)) :: (_t'3, tint) ::
              ...
              (Sset _t'5
                (Efield
                  (Ederef (Etempvar _pn__2 (tptr (Tstruct _pn noattr)))
                    (Tstruct _pn noattr)) _p (tptr (Tstruct _node noattr))))
              (Scall (Some _t'4)
                (Evar _lookupOp_helper (Tfunction
                                         ((tptr (Tstruct _css noattr)) ::
                                          (tptr (Tstruct _node noattr)) ::
                                          tint :: tint :: nil) (tptr tvoid)
                                         cc_default))
                ((Etempvar _t (tptr (Tstruct _css noattr))) ::
                 (Etempvar _t'5 (tptr (Tstruct _node noattr))) ::
                 (Etempvar _x tint) :: (Etempvar _status tint) :: nil)))
...
((___compcert_va_int32,
 ...
 (_get_root,
   Gfun(External (EF_external "get_root"
                   (mksignature (AST.Xptr :: nil) AST.Xptr cc_default))
     ((tptr (Tstruct _css noattr)) :: nil) (tptr (Tstruct _node noattr))
     cc_default)) ::
 (_traverse,
   Gfun(External (EF_external "traverse"
                   (mksignature (AST.Xptr :: AST.Xptr :: AST.Xint :: nil)
                     AST.Xint cc_default))
     ((tptr (Tstruct _css noattr)) :: (tptr (Tstruct _pn noattr)) :: tint ::
      nil) tint cc_default)) ::
 (_insertOp_helper,
   Gfun(External (EF_external "insertOp_helper"
                   (mksignature
                     (AST.Xptr :: AST.Xptr :: AST.Xint :: AST.Xptr :: nil)
                     AST.Xvoid cc_default))
     ((tptr (Tstruct _css noattr)) :: (tptr (Tstruct _node noattr)) ::
      tint :: (tptr tvoid) :: nil) tvoid cc_default)) ::
 (_lookupOp_helper,
   Gfun(External (EF_external "lookupOp_helper"
                   (mksignature
                     (AST.Xptr :: AST.Xptr :: AST.Xint :: AST.Xint :: nil)
                     AST.Xptr cc_default))
     ((tptr (Tstruct _css noattr)) :: (tptr (Tstruct _node noattr)) ::
      tint :: tint :: nil) (tptr tvoid) cc_default)) ::
 (_insert, Gfun(Internal f_insert)) :: (_lookup, Gfun(Internal f_lookup)) ::
 nil).

Definition public_idents : list ident :=
(_lookup :: _insert :: _lookupOp_helper :: _insertOp_helper :: _traverse ::
 _get_root :: _exit :: _free :: _malloc :: ___builtin_debug ::
